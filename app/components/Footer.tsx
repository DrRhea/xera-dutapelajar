...
export default function Footer() {
  return (
    <footer className="bg-tinkerbell-secondary text-white py-16 md:py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 lg:gap-8 mb-12 md:mb-16">
          ...
          <div className="lg:col-span-2 space-y-4">
            <div className="flex items-center gap-3">
              ...
              />
              <div>
                <p className="font-bold text-lg">Duta Pelajar Remaja Indonesia</p>
                <p className="text-white/80 text-sm">Program Pesona Prestasi Official</p>
              </div>
            </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3 text-white/80 text-sm">
              ...
              <li><Link href="/timeline" className="hover:text-white transition">Program Kami</Link></li>
              <li><Link href="/fasilitas" className="hover:text-white transition">Fasilitas</Link></li>
              <li><Link href="/agenda" className="hover:text-white transition">Agenda</Link></li>
              <li>
                <a href="https://instagram.com/dpr_indonesia.official" target="_blank" rel="noopener noreferrer" className="hover:text-white transition">
                  Kontak
                </a>
              </li>
            </ul>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3 text-white/80 text-sm">
              <li><Link href="/agenda" className="hover:text-white transition">Event & Kegiatan</Link></li>
              <li>
                <a href="/documents/Pedoman-DPRI-2026.pdf" download="Pedoman-DPRI-2026.pdf" className="hover:text-white transition">
                  Unduh Pedoman DPRI
                </a>
              </li>
            </ul>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3 text-white/80 text-sm">
              <li><Link href="/" className="hover:text-white transition">Duta Pelajar Remaja Indonesia</Link></li>
            </ul>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-4 text-white/80 text-sm">
              <li className="flex items-center gap-3">
                ...
                <a href="tel:+6282148538720" className="hover:text-white transition">+62 821-4853-8720</a>
              </li>
              <li className="flex items-center gap-3">
                <span className="flex-shrink-0 w-8 h-8 rounded-full bg-white/10 flex items-center justify-center">
        ...
        {/* Bottom section */}
        <div className="border-t border-white/20 pt-8 md:pt-10 flex flex-col sm:flex-row justify-between items-center gap-4">
