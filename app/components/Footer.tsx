        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 items-start">
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-gray-200 text-base">
              ...
              <li><Link href="/fasilitas" className="hover:text-accent transition">Fasilitas</Link></li>
              <li><Link href="/unduhan" className="hover:text-accent transition">Unduhan</Link></li>
              <li><Link href="/kontak" className="hover:text-accent transition">Kontak</Link></li>
            </ul>
          </div>
        ...
        <div className="border-t border-white/10 mt-12 pt-6 flex flex-col sm:flex-row justify-between items-center gap-3">
          ...
          <div className="flex items-center gap-3 order-1 sm:order-2">
            <a
              ...
              className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center text-white hover:bg-accent/20 hover:text-accent transition"
