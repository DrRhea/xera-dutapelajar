      ...
      <section className="py-20 bg-tinkerbell-bg">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-8">
            {/* Card 1 - Penginapan */}
            <div className="bg-white rounded-xl shadow-lg p-8 border-t-4 border-tinkerbell-cta hover:shadow-xl transition-shadow">
              <div className="flex flex-col space-y-4">
                <div className="w-16 h-16 bg-tinkerbell-cta/10 rounded-full flex items-center justify-center mb-4">
                  <svg className="w-8 h-8 text-tinkerbell-cta" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 border-t-4 border-tinkerbell-secondary hover:shadow-xl transition-shadow">
              <div className="flex flex-col space-y-4">
                <div className="w-16 h-16 bg-tinkerbell-secondary/10 rounded-full flex items-center justify-center mb-4">
                  <svg className="w-8 h-8 text-tinkerbell-secondary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
